...
@BindingAdapter("setLogoImageBaseUrlFiles")
fun setLogoImageBaseUrlFiles(view: ImageView, url: String?) {
    Timber.d("the logo url is == $url")
    Timber.d("the logo url is == ${AppVar.APP_LOGO}")
